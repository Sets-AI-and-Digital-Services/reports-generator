...
const CSV_PATH = ["/data/dwelling_time/north_axis_start_station.csv", "/data/dwelling_time/train_station.csv"];
...
export default function OperatorColumnMapStyled() {
  ...
  return (
    <div ref={containerRef} className="relative w-full h-full">  <DeckGL
