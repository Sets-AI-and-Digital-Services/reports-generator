...
const BenefitsToTheCity = () => {
  return (
    <section className="w-full h-screen py-16 bg-gradient-to-b from-white to-[#dff1ed]">
      <div className="mx-auto text-center">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="rounded-3xl text-left w-[70%] m-auto text-2xl"
        >
          <div className="flex mb-4 items-center rounded-xl px-6 py-4 gap-[12px] bg-white border border-[#F3FCF6] shadow-[0px_4.27px_6.41px_rgba(180,201,194,0.1)]">
          ...
          <div className="flex mb-4 justify-between">
            <div className="flex items-center w-[49.5%] rounded-xl px-6 py-4 gap-[12px] bg-white border border-[#F3FCF6] shadow-[0px_4.27px_6.41px_rgba(180,201,194,0.1)]">
